...
MODEL_TITLES = {
    "distill_qwen_7b": "DeepSeek-Distill-Qwen-7B",
    "distill_qwen_1.5b": "DeepSeek-Distill-Qwen-1.5B",
    "qwen_4b": "Qwen3-4B",
    "qwen_8b": "Qwen3-8B",
}
# ---------------------------------------------------------
LANGS = ["bn", "en", "de", "es", "fr", "ja", "ko", "ru", "sw", "te", "th", "zh"]
# ---------------------------------------------------------
...
def main() -> None:
    ...
    out_name = f"{DATASET}_perlang.png"
