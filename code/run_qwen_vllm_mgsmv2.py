...
def prompt_qwen_vllm(
    ...
    with open(input_path, "r", encoding="utf-8") as f_in, open(output_path, "a", encoding="utf-8") as f_out:
        for line in f_in:
            ...
            answer_markers = ["Answer:", "**Answer:**", "Final Answer:", "**Final Answer:**", "### Final Answer"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_name", default="qwen14b")
    ...
    llm = LLM(
        ...
        # max_model_len=60000,          # ↓ reduce from 131072 to fit memory
        # gpu_memory_utilization=0.9,   # let vLLM use most of the VRAM
    )

    languages = ["en", "bn", "de", "es", "fr", "ja", "ru", "sw", "te", "th", "zh"]
    for language in languages:
        input_path = f"../data/mgsm_revised/{language}.jsonl"
        output_path = f"../res/mgsm_revised_t{str(args.iteration)}/{args.save_name}/{language}.jsonl"
